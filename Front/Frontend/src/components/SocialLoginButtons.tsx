...
export const SocialLoginButtons = (): JSX.Element => {
  const socialOptions = [
    {
      name: "Facebook",
      icon: (
      ...
      <div className="mt-6 grid grid-cols-2 gap-3">
        {socialOptions.map((option) => (
          <Button
            ...
            className={`${option.color} flex items-center justify-center py-2 px-4 rounded-lg transition-all duration-200 transform hover:scale-105`}
          >
            {option.icon}
          </Button>
        ))}
